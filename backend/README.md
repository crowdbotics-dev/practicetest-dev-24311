...
## Project Structure
    ...
    ├── practicetest_dev_24311  # Django project configurations
...
1. Clone this repo and `cd practicetest_dev_24311`
...
2. Clone this repo and `cd practicetest_dev_24311`
